...
import numpy as np
from utils.provider import rotate_point_cloud, rotate_feature_point_cloud


if __name__ == "__main__":
    # Parser
    parser = argparse.ArgumentParser()
    parser.add_argument("--pcd_path", default="./log/seg_result/sparse/mls2016_8class_20cm_ascii_test_val.pcd", type=str)
    parser.add_argument("--labels_path", default="./log/seg_result/sparse/mls2016_8class_20cm_ascii_test_val.labels", type=str)
